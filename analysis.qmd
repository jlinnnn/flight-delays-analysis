...
```{r daily-patterns}
daily_flights <- read_csv("SQL_exports/Joshua_Lin_Mini_Project_Problem07.csv",
...
```{r day-of-week}
day_patterns <- read_csv("SQL_exports/Joshua_Lin_Mini_Project_Problem03.csv",
                         show_col_types = FALSE)
...
```{r}
max_delays <- read_csv("SQL_exports/Joshua_Lin_Mini_Project_Problem01.csv",
                       show_col_types = FALSE)
```
...
early_deps <- read_csv("SQL_exports/Joshua_Lin_Mini_Project_Problem02.csv",
                       show_col_types = FALSE)
...
```{r worst-airport}
worst_airport <- read_csv("SQL_exports/Joshua_Lin_Mini_Project_Problem04.csv",
                          show_col_types = FALSE)
...
airline_worst <- read_csv("SQL_exports/Joshua_Lin_Mini_Project_Problem05.csv",
                          show_col_types = FALSE)
...
cancellations <- read_csv("SQL_exports/Joshua_Lin_Mini_Project_Problem06a.csv",
                          show_col_types = FALSE)
...
cancel_reasons <- read_csv("SQL_exports/Joshua_Lin_Mini_Project_Problem06b.csv",
                           show_col_types = FALSE)
...
**Full SQL Script**: All queries are available in `SQL_exports/Joshua_Lin_Mini_Project_Problems.sql`
